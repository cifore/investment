...
public class MutualFundServiceImpl implements MutualFundService {
	...
	@Transactional
	public Map<String, Object> openingFUNccount(HeaderModel header, InvestmentOpeningAccountModel fun, RestTemplate restTemplate)
			throws Exception {
       ...
       //根据 debitAccountNum
  		String debitAccountParam = "{\"customerNumber\":\"" + header.getCustomerNumber() +"\",\"accountNumber\":\"" + fun.getAccountnumber() +"\",\"countrycode\":\"" + header.getCountryCode() +"\",\"clearingcode\":\"" + header.getClearingCode() +"\",\"branchcode\":\"" + header.getBranchCode() +"\"}";
...
//		String localccy = null;
		Map<String, Object> map3 = GenerateAccountNumberUtil.getAccountNumber(SysConstant.ACCOUNT_TYPE8, header, restTemplate);
